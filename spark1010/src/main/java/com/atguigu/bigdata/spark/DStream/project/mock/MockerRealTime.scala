package com.atguigu.bigdata.spark.DStream.project.mock

import java.util.{Properties, Random}

import com.atguigu.bigdata.spark.DStream.project.bean.CityInfo
import com.atguigu.bigdata.spark.DStream.project.utils.{PropertiesUtil, RanOpt,RandomOptions}
